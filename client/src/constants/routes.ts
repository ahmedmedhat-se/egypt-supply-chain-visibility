export const ROUTES = {
  ...
  SHIPMENTS_ADMIN: "/admin/shipments",
  SHIPMENTS_SHIPPER: "/shipper/shipments",
  SHIPMENTS_CARRIER: "/carrier/shipments",
  SHIPMENTS_REGULATOR: "/regulator/shipments",
  SHIPMENTS_SUPER_ADMIN: "/super-admin/shipments",
  TRACKING: "/tracking",
