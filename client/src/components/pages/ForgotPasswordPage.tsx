    ...
    <div className="min-h-screen flex items-center justify-center bg-[#F8FAFC] dark:bg-[#0A2E4A] p-4">
      <Card variant="elevated" className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-[#0A2E4A] dark:text-white">Reset Password</h1>
          <p className="text-[#94A3B8] dark:text-[#94A3B8] mt-2">We'll help you get back into your account</p>
        </div>
